...
{
	void Quad::Load(Renderer::Renderer& renderer, const std::string& vertPath, const std::string& fragPath, const std::string& texturePath)
	{
		basePath = SDL_GetBasePath();
		vertexShader = renderer.LoadShader(basePath, vertPath.c_str(), 0, 1, 0, 0);
		fragmentShader = renderer.LoadShader(basePath, fragPath.c_str(), 1, 1, 0, 0);
		...
		transferData[0] = PositionTextureVertex{ -0.5f, -0.5f, 0, 0, 1 };
		transferData[1] = PositionTextureVertex{ 0.5f, -0.5f, 0, 1, 1 };
		transferData[2] = PositionTextureVertex{ 0.5f, 0.5f, 0, 1, 0 };
		transferData[3] = PositionTextureVertex{ -0.5f, 0.5f, 0, 0, 0 };
	...
	void Quad::Draw(Renderer::Renderer& renderer)
	{
		renderer.Begin();
	...
	void Quad::Unload(Renderer::Renderer& renderer)
	{
