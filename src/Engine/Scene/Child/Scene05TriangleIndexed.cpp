#include "Scene05TriangleIndexed.h"
...
{
	void Scene05TriangleIndexed::Load(Renderer::Renderer& renderer) 
	{
	...
	bool Scene05TriangleIndexed::Update(float dt)
	{
	...
	void Scene05TriangleIndexed::Draw(Renderer::Renderer& renderer)
	{
		renderer.Begin();
	...
	void Scene05TriangleIndexed::Unload(Renderer::Renderer& renderer) 
	{
