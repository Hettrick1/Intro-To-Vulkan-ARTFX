#include "Scene07TextureQuadMoving.h"
...
using Engine::Maths::Mat4;

namespace Engine::Scene
{
	void Scene07TextureQuadMoving::Load(Renderer::Renderer& renderer) 
	{
	...
	bool Scene07TextureQuadMoving::Update(float dt) 
	{
	...
	void Scene07TextureQuadMoving::Unload(Renderer::Renderer& renderer) 
	{
	...
	void Scene07TextureQuadMoving::Draw(Renderer::Renderer& renderer) 
	{
		renderer.Begin();
