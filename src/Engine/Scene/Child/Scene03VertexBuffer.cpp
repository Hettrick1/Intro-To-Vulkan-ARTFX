...
{
	void Scene03VertexBuffer::Load(Renderer::Renderer& renderer) {
	...
	void Scene03VertexBuffer::Draw(Renderer::Renderer& renderer) {
		renderer.Begin();
	...
	void Scene03VertexBuffer::Unload(Renderer::Renderer& renderer) {
