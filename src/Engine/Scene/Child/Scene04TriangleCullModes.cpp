...
{
	void Scene04TriangleCullModes::Load(Renderer::Renderer& renderer) 
	{
	...
	void Scene04TriangleCullModes::Draw(Renderer::Renderer& renderer) 
	{
		renderer.Begin();
	...
	void Scene04TriangleCullModes::Unload(Renderer::Renderer& renderer) 
	{
