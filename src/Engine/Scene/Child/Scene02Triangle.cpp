...
{
	void Scene02Triangle::Load(Renderer::Renderer& renderer)
	{
	...
	bool Scene02Triangle::Update(float dt)
	{
		...
		if (inputState.IsPressed(Input::DirectionalKey::Up)) 
		{
	...
	void Scene02Triangle::Draw(Renderer::Renderer& renderer)
	{
		renderer.Begin();
	...
	void Scene02Triangle::Unload(Renderer::Renderer& renderer)
	{
